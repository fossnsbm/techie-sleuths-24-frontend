...
export default function NavigationMenuHamburger() {
  ...
  return (
    <div className="flex flex-col items-end justify-center z-50 py-16">
      ...
      <div
        className={`absolute right-0 mt-64 w-48 rounded-md bg-sky-100 shadow-lg bg-gray-0 z-50 ring- p-5 justify-center items-center transition-all duration-200 ease-in-out gap-5 ${
